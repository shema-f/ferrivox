  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, -0.1, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#050810" metalness={0.4} roughness={0.7} />
      </mesh>
      <gridHelper args={[80, 40, "#1a1500", "#0a0800"]} position={[0, 0, 0]} />
      ...
      {LAYER_SIZES.map((_, li) => {
        const x =
          li * LAYER_SPACING - ((LAYER_SIZES.length - 1) * LAYER_SPACING) / 2
