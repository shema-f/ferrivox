...
function ProjectBuilding({
  ...
  useFrame((state) => {
    ...
    mat.emissiveIntensity =
      0.8 + Math.sin(state.clock.elapsedTime * 1.2 + x) * 0.4
  })
  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, -0.1, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#030608" metalness={0.4} roughness={0.7} />
      </mesh>
      <gridHelper args={[100, 50, "#001a2e", "#000a15"]} position={[0, 0, 0]} />
